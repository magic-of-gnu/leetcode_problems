...
781 | Rabbits in Forest | https://leetcode.com/problems/rabbits-in-forest/ | 16 June 2021 | Medium | Hash Table | Group A | `O(n)` | `O(n)`
1048 | Longest String Chain | https://leetcode.com/problems/longest-string-chain/ | 15 June 2021 | Medium | Hash Table | Group B | `O(n logn + n^2 k)` | `O(n)`
974 | Subarray Sums Divisible by K | https://leetcode.com/problems/subarray-sums-divisible-by-k/ | 16 June 2021 | Medium | Hash Table | Group B | `O(N**2)` | `O(N)`
970 | Powerful Integers | https://leetcode.com/problems/powerful-integers/ | 17 June 2021 | Medium | Hash Table | Group A | `O(NM)` | `O(NM)`
400 | Nth Digit | https://leetcode.com/problems/nth-digit/ | 17 June 2021 | Medium | Math | Group A | `O(logn)` | `O(1)`
523 | Continuous Subarray Sum | https://leetcode.com/problems/continuous-subarray-sum/ | 17 June 2021 | Medium | Hash Table | Group B | `O(n)` | `O(k)`
1884 | Egg Drop With 2 Eggs and N Floors | https://leetcode.com/problems/egg-drop-with-2-eggs-and-n-floors/ | 17 June 2021 | Medium | Math | Group B | `O(1)` | `O(1)`
1870 | Minimum Speed to Arrive on Time | https://leetcode.com/problems/minimum-speed-to-arrive-on-time/ | 17 June 2021 | Medium | Math | Group B | `O(1)` | `O(1)`
1276 | Number of Burgers with No Waste of Ingredients | https://leetcode.com/problems/number-of-burgers-with-no-waste-of-ingredients/ | 17 June 2021 | Medium | Math | Group A | `O(1)` | `O(1)`
869 | Reordered Power of 2 | https://leetcode.com/problems/reordered-power-of-2/ | 17 June 2021 | Medium | Math | Group A | `O(N + logN)` | `O(1)`
858 | Mirror Reflection | https://leetcode.com/problems/mirror-reflection/ | 17 June 2021 | Medium | Math | Group B | - | -
319 | Bulb Switcher | https://leetcode.com/problems/bulb-switcher/ | 18 June 2021 | Medium | Math | Group B | `O(N^2)` | `O(N)`
1375 | Bulb Switcher III | https://leetcode.com/problems/bulb-switcher-iii/ | 20 June 2021 | Medium | Math | Group A | `O(n)` | `O(1)`
670 | Maximum Swap |  https://leetcode.com/problems/maximum-swap/ | 20 June 2021 | Medium | Math | Group B | - | -
794 | Valid Tic-Tac-Toe State | https://leetcode.com/problems/valid-tic-tac-toe-state/ | 21 June 2021 | Medium | Math | Group A | `O(N)` | `O(N)`
1685 | Sum of Absolute Differences in a Sorted Array | https://leetcode.com/problems/sum-of-absolute-differences-in-a-sorted-array/ | 22 June 2021 | Medium | Math | Group A | `O(n)` | `O(1)`
1860 | Incremental Memory Leak| https://leetcode.com/problems/incremental-memory-leak/ | 24 June 2021 | Medium | Math | Group A | `O(1)` | `O(1)`
1878 | Get Biggest Three Rhombus Sums in a Grid | https://leetcode.com/problems/get-biggest-three-rhombus-sums-in-a-grid | 24 June 2021 | Medium | Math | Group A | `O(nm*min(n,m))` | `O(1)`
365 | Water and Jug Problem | https://leetcode.com/problems/water-and-jug-problem/ | 24 June 2021 | Medium | Math | Group B | `O(1)` | `O(1)`
1292 | Maximum Side Length of a Square with Sum Less than or Equal to Threshold | https://leetcode.com/problems/maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold/ | 25 June 2021 | Medium | Math | Group B | - | -
357 | Count Numbers with Unique Digits | https://leetcode.com/problems/count-numbers-with-unique-digits/ | 25 June 2021 | Medium | Math | Group B | `O(1)` | `O(1)`
368 | Largest Divisible Subset | https://leetcode.com/problems/largest-divisible-subset/ | 25 June 2021 | Medium | Math | Group A | `O(n**2)` | `O(mk)` where `m` - amount of combinations, `k` - average length of each combination
1432 | Max Difference You Can Get From Changing an Integer | https://leetcode.com/problems/max-difference-you-can-get-from-changing-an-integer/ | 26 June 2021 | Medium | Math | Group A | `O(N)` | `O(1)`
1140 | Stone Game II | https://leetcode.com/problems/stone-game-ii/ | 27 June 2021 | Medium | Math | Group B | - | -
200 | Number of Islands | https://leetcode.com/problems/number-of-islands/ | 06 July 2021 | Medium | DFS | Group A | `O(N+K)` (N - grid cells, K - cells of land) | `O(1)`
337 | House Robber III | https://leetcode.com/problems/house-robber-iii/ | 08 July 2021 | Medium | DFS | Group B | `O(N)` | `O(N)` | can be reduced to `O(1)`, solution fails at the last 8 cases, do not know why
198 | House Robber | https://leetcode.com/problems/house-robber/ | 08 July 2021 | Medium | DFS | Group A | `O(N)` | `O(1)`
213 | House Robber II | https://leetcode.com/problems/house-robber-ii/ | 09 July 2021 | Medium | DFS | Group B | - | - |
1473 | Paint House III | https://leetcode.com/problems/paint-house-iii/ | 09 July 2021 | Hard | DFS | Group B | - | - | 
207 | Course Schedule | https://leetcode.com/problems/course-schedule/ | 10 July 2021 | Medium | DFS | Group B | - | - | could not solve it
...
54 | Spiral Matrix | https://leetcode.com/problems/spiral-matrix/ | 29 July 2021 | Medium | Matrix | Group A | `O(NM)` | `O(1)` | Easy problem that requires just to think
...
1081 | Smallest Subsequence of Distinct Characters | https://leetcode.com/problems/smallest-subsequence-of-distinct-characters | 20 August 2021 | Medium | Monotonic Stack | Group B | - | - | solution in discussion can be improved
...
224 | Basic Calculator | https://leetcode.com/problems/basic-calculator/ | 19 October 2021 | Medium | Math, String, Stack, Recursion | Group A | `O(N)` | `O(N)` |
...
48 |  Rotate Image | 29 October 2021 | Medium | Array, Math, Matrix | Group A | `O(N2)` | `O(1)` | Solved this problem for the second time :)
...
209 | Minimum Size Subarray Sum | https://leetcode.com/problems/minimum-size-subarray-sum/ | 30 October 2021 | Medium | Array, Binary Search, Sliding Window, Prefix Sum | Group A | `O(N)` | `O(1)` | Easy problem :)
